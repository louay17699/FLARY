    ...
    <header className="border-b border-base-300 fixed w-full top-0 z-40 backdrop-blur-lg bg-base-100/80 h-16">
      <div className="container mx-auto px-4 h-full">
        <div className="flex items-center justify-between h-full">
          ...
          >
            <div className="size-9 rounded-lg bg-gradient-to-br from-primary to-secondary flex items-center justify-center transition-transform group-hover:rotate-12 shadow-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            {authUser && (
              <Link
                to="/profile"
                className="btn btn-sm h-10 px-4 gap-2 bg-base-200 hover:bg-primary/10 hover:text-primary transition-colors duration-200 shadow-sm normal-case"
              >
            ...
            {authUser && (
              <button 
                className="btn btn-sm h-10 gap-2 hover:bg-error/10 hover:text-error transition-colors"
                onClick={logout}
              >
