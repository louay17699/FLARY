...
const SidebarSkeleton = () => {
  ...
  return (
    <aside className="h-full w-16 lg:w-72 border-r border-base-300/50 bg-base-100/80 backdrop-blur-sm flex flex-col transition-all duration-200">
      ...
      <div className="border-b border-base-300/50 w-full p-4 space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden lg:block skeleton h-6 w-24 rounded-md" />
          </div>
          <div className="lg:hidden skeleton size-8 rounded-md" />
        </div>
      ...
      {/* Mobile skeleton */}
      <div className="lg:hidden flex flex-col items-center py-3 space-y-4">
