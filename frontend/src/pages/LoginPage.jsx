...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-base-100 to-secondary/5 pt-14 pb-28">
          ...
          <div className="w-full max-w-md space-y-8 bg-base-100/90 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-base-200">
            ...
            <div className="text-center mb-8">
              <div className="flex flex-col items-center gap-2 group">
                ...
                <p className="text-base-content/60">Sign in to continue your FLARY journey</p>
              </div>
            </div>
